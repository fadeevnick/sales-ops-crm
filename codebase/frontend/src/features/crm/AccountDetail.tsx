                      ...
                      <td>
                        <div style={{ display: "flex", gap: 4 }}>
                          <button
                            ...
                            onClick={e => {
                              e.stopPropagation();
                              onAction(`Opening email to ${c.fullName}…`);
                            }}
                          >
                            Email
                          </button>
                          <button
                            ...
                            onClick={e => {
                              e.stopPropagation();
                              onAction(`Logging call with ${c.fullName}…`);
                            }}
                          >
                            Log call
                          </button>
    ...
    <div className="acct-contact-expand">
      ...
      <div className="acct-contact-expand-actions">
        <button
          className="rep-btn"
          type="button"
          onClick={() => onAction(`Opening email to ${contact.fullName}…`)}
        >
          Email
        </button>
        <button
          className="rep-btn"
          type="button"
          onClick={() => onAction(`Logging call with ${contact.fullName}…`)}
        >
          Log call
        </button>
        <button
          className="rep-btn"
          type="button"
          onClick={() => onAction(`Adding note for ${contact.fullName}…`)}
        >
          Add note
        </button>
        {!contact.isPrimary ? (
          <button
            className="rep-btn rep-btn-ghost"
            type="button"
            onClick={() => onAction(`${contact.fullName} set as primary contact`)}
          >
            Set primary
          </button>
        ) : null}
