...
```bash
bash -n scripts/orchestration/external-staging-acceptance.sh scripts/orchestration/staging-deploy.sh scripts/orchestration/staging-post-deploy-gates.sh
EXTERNAL_STAGING_ACCEPTANCE_ENV_FILE=/tmp/salesops-rendered-staging.env EXTERNAL_STAGING_ACCEPTANCE_BACKUP_DIR=/tmp scripts/orchestration/external-staging-acceptance.sh
